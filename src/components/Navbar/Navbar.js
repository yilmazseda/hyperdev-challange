...
const Navbar = () => {
  ...
  return (
    <div className="border-border-top-color border-t-4">
      <div className="flex w-full justify-between bg-white  items-center max-w-7xl mx-auto  p-8">
        ...
        <nav className="flex items-center justify-between flex-wrap mr-12 ">
          <div className="block size-992:hidden">
            <button className="flex items-center px-3 pr-8	 py-2 rounded  ">
              <svg
